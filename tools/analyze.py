...
class CodeAnalyzer:
    ...
    def analyze_all(self):
        ...
        cpp_files = list((self.repo_root / "firmware").glob("*.cpp"))
        cpp_headers = list((self.repo_root / "firmware").glob("*.h"))
        py_files = list((self.repo_root / "cloud").glob("*.py"))
...
def main():
    ...
    # Find repo root (parent of tools directory)
    ...
    output_file = tools_dir / "knowledge_base.json"
